  ...
  return (
    <div className="mx-auto flex min-h-svh max-w-3xl flex-col gap-8 px-4 py-12">
      <header className="flex flex-col gap-2">
        ...
        <p className="typography-heading-medium">Figma UI3 Components for your Figma plugins</p>
      </header>
      <div className="flex items-center gap-2">
        ...
        <Button
          ...
          size="icon"
          render={
            <a href="https://github.com/anxndsgn/figui" target="_blank" rel="noopener noreferrer">
              <GithubIcon />
            </a>
          }
        />
      ...
      <main className="grid flex-1 grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="relative col-span-1 row-span-1 flex min-h-24 flex-col gap-4 rounded-lg border border-grey-200 p-4 dark:border-grey-600">
          <div className="flex items-center justify-between">
            ...
            <Button
              render={
                <Link to="/docs/$" params={{ _splat: "components/checkbox" }}>
                  Docs <ArrowUpRightIcon />
                </Link>
              }
              variant="secondary"
        ...
        <div className="relative col-span-1 row-span-1 flex min-h-24 flex-col gap-4 rounded-lg border border-grey-200 p-4 dark:border-grey-600">
          <div className="flex items-center justify-between">
            ...
            <Button
              render={
                <Link to="/docs/$" params={{ _splat: "components/inputs/text-input" }}>
                  Docs <ArrowUpRightIcon />
                </Link>
              }
              variant="secondary"
        ...
        <div className="relative col-span-1 row-span-1 flex min-h-24 flex-col gap-4 rounded-lg border border-grey-200 p-4 dark:border-grey-600">
          <div className="flex items-center justify-between">
            ...
            <Button
              render={
                <Link to="/docs/$" params={{ _splat: "components/slider" }}>
                  Docs <ArrowUpRightIcon />
                </Link>
              }
              variant="secondary"
        ...
        <Button render={<Link to="/docs">Find More</Link>} size="large" className="col-span-full" />
      </main>
    </div>
  );
}
